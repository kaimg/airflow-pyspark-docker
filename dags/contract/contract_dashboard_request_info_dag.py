...
from scripts.contract.contract_dashboard_request_info_job import run_contract_dashboard_request_info_pipeline
...
with DAG(
    ...
    run_spark_job = PythonOperator(
        task_id="run_contract_dashboard_request_info_etl",
        python_callable=run_contract_dashboard_request_info_pipeline,
        op_kwargs={
