...
ETL_CONFIG = {
    "bid_evaluation_file_upload_pipeline": {
        "source_tables": [
            {
...
def extract_tables(
    spark,
    pipeline_name="bid_evaluation_file_upload_pipeline",
    jdbc_url=None,
    db_properties=None,
):
    print(
...
def transform_bid_evaluation_file_upload_sql(
    spark,
    extracted_dfs,
    pipeline_name="bid_evaluation_file_upload_pipeline",
    jdbc_url=None,
...
def run_bid_evaluation_file_upload_pipeline(**kwargs):
    pipeline_name = "bid_evaluation_file_upload_pipeline"
    ...
    try:
        ...
        transformed_df = transform_bid_evaluation_file_upload_sql(
