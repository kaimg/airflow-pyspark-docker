...
ETL_CONFIG = {
    "contract_dashboard_pricebook_and_pricebook_product_info_pipeline": {
        "source_tables": [
            {"name": "pricebooks_pricebookproduct", "schema": "public", "alias": "pricebooks_pricebookproduct"},
            {"name": "pricebooks_pricebookvalues", "schema": "public", "alias": "pricebooks_pricebookvalues"},
            {"name": "pb_required_field", "schema": "public", "alias": "pb_required_field"},
            {"name": "pricebooks_pricebook", "schema": "public", "alias": "pricebooks_pricebook"}
        ],
...
def extract_tables(spark, pipeline_name="contract_dashboard_pricebook_and_pricebook_product_info_pipeline", jdbc_url=None, db_properties=None):
    print(
...
def transform_contract_dashboard_pricebook_and_pricebook_product_info_sql(spark, extracted_dfs, pipeline_name="contract_dashboard_pricebook_and_pricebook_product_info_pipeline", jdbc_url=None, db_properties=None, sql_file_path=None):
...
def run_contract_dashboard_pricebook_and_pricebook_product_info_pipeline(**kwargs):
    pipeline_name = "contract_dashboard_pricebook_and_pricebook_product_info_pipeline"
    ...
    sql_file_path = kwargs.get("sql_file_path", "dags/sql/contract/contract_dashboard_pricebook_and_pricebook_product_info.sql")
    ...
    try:
        ...
        transformed_df = transform_contract_dashboard_pricebook_and_pricebook_product_info_sql(spark, extracted_dfs, pipeline_name, jdbc_url, db_properties, sql_file_path)
