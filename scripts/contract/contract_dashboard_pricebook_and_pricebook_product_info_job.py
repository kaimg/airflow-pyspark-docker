...
def transform_contract_dashboard_pricebook_and_pricebook_product_info_sql(
    spark,
    extracted_dfs,
    pipeline_name="contract_dashboard_pricebook_and_pricebook_product_info_pipeline",
    jdbc_url=None,
...
def run_contract_dashboard_pricebook_and_pricebook_product_info_pipeline(**kwargs):
    ...
    sql_file_path = kwargs.get(
        "sql_file_path",
        "dags/sql/contract/contract_dashboard_pricebook_and_pricebook_product_info.sql",
    )
    ...
    try:
        ...
        transformed_df = (
            transform_contract_dashboard_pricebook_and_pricebook_product_info_sql(
                spark,
                extracted_dfs,
                pipeline_name,
                jdbc_url,
