...
def extract_tables(spark, pipeline_name="contract_service_request_products_pipeline", jdbc_url=None, db_properties=None):
    print(
...
def transform_contract_service_request_products_sql(spark, extracted_dfs, pipeline_name="contract_service_request_products_pipeline", jdbc_url=None, db_properties=None, sql_file_path=None):
...
def run_contract_service_request_products_pipeline(**kwargs):
    ...
    sql_file_path = kwargs.get("sql_file_path", "dags/sql/contract/contract_service_request_products.sql")
    ...
    try:
        ...
        transformed_df = transform_contract_service_request_products_sql(spark, extracted_dfs, pipeline_name, jdbc_url, db_properties, sql_file_path)
