...
ETL_CONFIG = {
    "contract_dashboard_request_info_pipeline": {
        "source_tables": [
            {"name": "contract_service_requests", "schema": "public", "alias": "contract_service_requests"}
        ],
...
def extract_tables(spark, pipeline_name="contract_dashboard_request_info_pipeline", jdbc_url=None, db_properties=None):
    print(
...
def transform_contract_dashboard_request_info_sql(spark, extracted_dfs, pipeline_name="contract_dashboard_request_info_pipeline", jdbc_url=None, db_properties=None, sql_file_path=None):
...
def run_contract_dashboard_request_info_pipeline(**kwargs):
    pipeline_name = "contract_dashboard_request_info_pipeline"
    ...
    sql_file_path = kwargs.get("sql_file_path", "dags/sql/contract/contract_dashboard_request_info.sql")
    ...
    try:
        ...
        transformed_df = transform_contract_dashboard_request_info_sql(spark, extracted_dfs, pipeline_name, jdbc_url, db_properties, sql_file_path)
